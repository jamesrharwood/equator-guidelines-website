...
## Resources
<button type="button" class="btn btn-primary btn-lg">Nostrud</button>
<button type="button" class="btn btn-primary btn-lg">Laboris</button>
<button type="button" class="btn btn-primary btn-lg">Deserunt</button>
...
Describe <span class="defined" data-bs-toggle="offcanvas" href="#offcanvasExample" role="button" aria-controls="offcanvasExample">irure sint ipsum aute eiusmod</span> irure laborum sunt minim. Irure aliquip do dolor do ea ipsum nostrud ea <abbr title='Here is a definition. Just a short sentence or two.'>exercitation elit Lorem ullamco</abbr> proident reprehenderit. Ipsum consequat nisi ullamco consectetur anim voluptate. 
...
> Eu cillum dolore aliquip voluptate et aliquip minim aute. Deserunt eu amet occaecat adipisicing sint cupidatat duis excepteur et aliqua excepteur. Do enim exercitation culpa enim in velit ullamco.
...
## Design advice and extra resouces
