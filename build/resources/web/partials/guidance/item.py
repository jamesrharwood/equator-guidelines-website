...
::: {{.g-col-3}}
::: {{.section .chat-button}}
<a href="{item.giscus_rel_path}" target="_blank"><i class="bi-chat-right-text" role="button"  data-bs-toggle="tooltip" data-bs-placement="top" data-bs-original-title="Discuss this item"></i></a>
:::
:::
:::
